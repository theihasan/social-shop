<template>
  <li>
    <a 
      ...
      :class="linkClasses"
    >
      <span class="mr-3" v-html="iconSvg"></span>
      {{ item.name }}
...
const iconSvg = computed(() => {
  const icons = {
    ...
    catalog: `<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"/>
    </svg>`,
    orders: `<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    instagram: `<svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987 6.62 0 11.987-5.367 11.987-11.987C24.014 5.367 18.637.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.49-3.323-1.297C4.198 14.895 3.708 13.743 3.708 12.446s.49-2.449 1.297-3.324C5.902 8.247 7.053 7.757 8.35 7.757s2.449.49 3.324 1.297c.897.875 1.387 2.026 1.387 3.323s-.49 2.448-1.297 3.323c-.875.897-2.026 1.388-3.323 1.388zm7.068 0c-1.297 0-2.449-.49-3.324-1.297-.896-.875-1.387-2.026-1.387-3.323s.49-2.448 1.297-3.323c.875-.897 2.026-1.388 3.323-1.388s2.448.49 3.323 1.297c.897.875 1.388 2.026 1.388 3.323s-.49 2.448-1.297 3.323c-.875.897-2.026 1.388-3.323 1.388z"/>
    </svg>`,
  ...
  return icons[props.item.icon] || `<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
